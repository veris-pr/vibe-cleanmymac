...
enum Theme {
    ...
    enum Font {
        ...
        static let bodySmall = SwiftUI.Font.system(size: 12, weight: .regular, design: .default)
        static let caption = SwiftUI.Font.system(size: 11, weight: .regular, design: .default)
        static let captionMedium = SwiftUI.Font.system(size: 11, weight: .medium, design: .default)
        static let captionBold = SwiftUI.Font.system(size: 11, weight: .semibold, design: .default)
        static let small = SwiftUI.Font.system(size: 10, weight: .regular, design: .default)
        static let smallMedium = SwiftUI.Font.system(size: 10, weight: .medium, design: .default)
        static let mini = SwiftUI.Font.system(size: 9, weight: .regular, design: .default)
        static let miniMedium = SwiftUI.Font.system(size: 9, weight: .medium, design: .default)
        static let miniMono = SwiftUI.Font.system(size: 9, weight: .medium, design: .monospaced)
